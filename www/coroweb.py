...
def get_required_kw_args(fn):
    # get all key_word-only arguments without default values:
    # Keyword only parameters are those which appear after a * or *args entry in a Python function definition
    # examples: def person (name, age, *, city, job):
    # another example: def person(name, age, *args):
    # remember *args and * can not be used in the same time
    args = []
    params = inspect.signature(fn).parameters # 获取函数的参数的列表
